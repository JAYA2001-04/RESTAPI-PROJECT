...
import com.example.project.Repository.RestaturantRepository;
import com.example.project.Service.RestaturantService;
...
@Service
public class ServiceImplement implements RestaturantService {
	
	RestaturantRepository resrepo;
	
	public ServiceImplement(RestaturantRepository resrepo) {
